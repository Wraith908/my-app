    ...
    return (
      <div>
        <div class="faqs-and-testimonials">
          ...
          <ul>
            <li>
            <Tile title = "What do I need to do after I’ve been accepted into my chosen degree?"
            ...
            <li>
            <Tile title = "I’m lost – how do I find out where I need to go?"
            ...
            <li>
            <Tile title = "How and Where do I Get Help?"
            ...
            <li>
            <Tile title = "Can I give my Student ID card to somebody else for them to use?"
            ...
            <li>
            <Tile title = "You should treat your student identification card with the same security as you would your bank debit or credit card. You shouldnotgive your student card to anyone else to use. Its everyone’s unique identity."
            ...
            <li>
            <Tile title = "How do I apply for scholarships?"
            ...
            <li>
            <Tile title = "How do I purchase a student parking permit?"
            ...
            <li>
            <Tile title = "I want to change degrees, how do I do that?"
            ...
            <li>
            <Tile title = "I forgot my password, how do I reset it?"
            ...
            <li>
            <Tile title = "I’m feeling blue and it’s affecting my study, is there anything I can do?"
